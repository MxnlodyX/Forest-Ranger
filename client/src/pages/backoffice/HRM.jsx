            ...
            <section className="p-6 md:p-8">
                <header className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Manage staff directory, access roles, and current duty status.</p>
                    </div>
                        ...
                        <div className="p-6 border-b border-gray-100 flex justify-between items-center shrink-0">
                            <div>
                                <h2 className="text-xl font-bold text-gray-900">
                                    ...
                                    {modalType === 'EDIT' && 'Edit Staff Information'}
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input required type="text" value={formData.username} onChange={e => setFormData({ ...formData, username: e.target.value })} className="w-full border-gray-300 rounded-lg p-2 text-sm outline-none focus:ring-2 focus:ring-emerald-500/30" placeholder="Set a username" />
                                            </div>
                                            <div>
                                                <label className="block text-xs font-medium text-gray-600 mb-1">Password {modalType === 'EDIT' && '(leave blank if unchanged)'}</label>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input required type="text" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} className="w-full border-gray-300 border rounded-lg p-2 text-sm outline-none focus:ring-2 focus:ring-emerald-500/30" placeholder="First and last name" />
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <select value={formData.role} onChange={e => setFormData({ ...formData, role: e.target.value })} className="w-full border-gray-300 border rounded-lg p-2 text-sm outline-none focus:ring-2 focus:ring-emerald-500/30">
                                                    <option value="Field-Ops">Field-Ops (Field Team)</option>
